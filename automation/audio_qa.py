...
def main():
    ...
    # Frame-level emptiness is video_qa.py's job, not this one's: a single
    # sampled frame is far too fragile (a fade between the hook card and the
    # first caption reads as "blank"), so it needs a per-second profile.
