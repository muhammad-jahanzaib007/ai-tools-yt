...
def generate_ranking_brief(topic, hook_style):
    user = (
        ...
        "Return a single JSON object with these keys:\n"
        "- slug: kebab-case, 3-6 words, no dates\n"
        "- title: a clickable YouTube title, <=70 chars, list-style with curiosity or money "
        "framing (e.g. 'Top 5 Free AI Tools That Feel Illegal to Use', '5 Free Alternatives "
...
def replenish_rankings(topics, want=12):
    try:
        ...
        user = (
            ...
            "YouTube creators'), tier-list style 'ranked worst to best'. Use the title "
            "language that wins in this niche: curiosity and money framing ('feel illegal "
            "to use', 'tier list', 'free alternatives to', 'better than ChatGPT', 'I ranked "
            "50, only 5 are worth it'), never neutral catalogue phrasing. Every idea must "
